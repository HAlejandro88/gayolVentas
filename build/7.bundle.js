(window.webpackJsonp=window.webpackJsonp||[]).push([[7],{21:function(e,t,n){"use strict";n.d(t,"a",(function(){return i}));var o=n(15);class i extends o.a{static get properties(){return{}}constructor(){super()}async __request(e="",t="GET",n={},o={}){const i=localStorage.getItem("url")?localStorage.getItem("url"):"http://localhost:5000/api/v1",s=JSON.stringify(o);let a={method:t,headers:{"Content-Type":"application/json",...n}};"PUT"!==t&&"POST"!==t||(a={...a,body:s});try{return await(await fetch(`${i}/${e}`,a)).json()}catch(e){return e}}async __authRequest(e,t=(()=>{})){const n=localStorage.getItem("token");if(n)try{const o=await this.__request("auth/verify/"+n);if(e&&o.verify)return t(),!0;if(!e||!o.success)return t(),!1}catch(e){console.log(e)}}}},32:function(e,t,n){"use strict";n.d(t,"a",(function(){return v}));var o=n(2),i=n(25),s=n(29),a=n(24),r=n(5),l=n(37);const d=Element.prototype,c=d.matches||d.matchesSelector||d.mozMatchesSelector||d.msMatchesSelector||d.oMatchesSelector||d.webkitMatchesSelector;var h=n(1);
/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/let p=0;const u={},m=e=>{p++;const t="vaadin-overlay-content-"+p,n=document.createElement("template"),o=document.createElement("style");o.textContent=":host { display: block; }"+e,n.content.appendChild(o),window.ShadyCSS&&window.ShadyCSS.prepareTemplate(n,t);const i=class extends HTMLElement{static get is(){return t}constructor(){super(),this.shadowRoot||(this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(document.importNode(n.content,!0)))}connectedCallback(){window.ShadyCSS&&window.ShadyCSS.styleElement(this)}};return customElements.define(i.is,i),u[e]=t,t};class v extends(Object(r.a)(Object(l.a)(o.a))){static get template(){return h.a`
    <style>
      :host {
        z-index: 200;
        position: fixed;
...
</dom-module>`;document.head.appendChild(a.content);var r=n(2),l=n(5),d=n(10);
/**
@license
Vaadin Login
...
</dom-module>`;document.head.appendChild(p.content);n(20),n(45);class u extends(c(Object(d.a)(Object(l.a)(r.a)))){static get template(){return s.a`
    <style>
...
</dom-module>`;document.head.appendChild(g.content);var y=n(22);
/**
@license
Vaadin Login
Copyright (C) 2018 Vaadin Ltd
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/const b=document.createElement("template");let _;b.innerHTML='<dom-module id="vaadin-login-overlay-wrapper-template">\n  <template>\n    <style>\n      [part="overlay"] {\n        outline: none;\n      }\n\n      [part="card"] {\n        max-width: 100%;\n        box-sizing: border-box;\n        overflow: hidden;\n        display: flex;\n        flex-direction: column;\n      }\n\n      [part="brand"] {\n        box-sizing: border-box;\n        overflow: hidden;\n        flex-grow: 1;\n        flex-shrink: 0;\n        display: flex;\n        flex-direction: column;\n        justify-content: flex-end;\n      }\n\n      [part="brand"] h1 {\n        color: inherit;\n        margin: 0;\n      }\n    </style>\n    <section part="card">\n      <div part="brand">\n        <slot name="title">\n          <h1 part="title">[[title]]</h1>\n        </slot>\n        <p part="description">[[description]]</p>\n      </div>\n      <div part="form">\n        <slot></slot>\n      </div>\n    </section>\n  </template>\n\n  \n</dom-module>',document.head.appendChild(b.content);class f extends v.a{static get is(){return"vaadin-login-overlay-wrapper"}static get properties(){return{title:{type:String},description:{type:String}}}static get template(){if(!_){_=super.template.cloneNode(!0);const e=y.a.import(this.is+"-template","template"),t=e.content.querySelector("[part=card]"),n=e.content.querySelector("style"),o=_.content.querySelector("#content");o.replaceChild(t,o.children[0]),o.appendChild(n)}return _}}customElements.define(f.is,f);
/**
@license
Vaadin Login
Copyright (C) 2018 Vaadin Ltd
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/
class w extends(c(Object(d.a)(Object(l.a)(r.a)))){static get template(){return s.a`
