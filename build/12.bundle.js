(window.webpackJsonp=window.webpackJsonp||[]).push([[12],{21:function(e,t,a){"use strict";a.d(t,"a",(function(){return s}));var r=a(15);class s extends r.a{static get properties(){return{}}constructor(){super()}async __request(e="",t="GET",a={},r={}){const s=localStorage.getItem("url")?localStorage.getItem("url"):"http://localhost:5000/api/v1",i=JSON.stringify(r);let n={method:t,headers:{"Content-Type":"application/json",...a}};"PUT"!==t&&"POST"!==t||(n={...n,body:i});try{return await(await fetch(`${s}/${e}`,n)).json()}catch(e){return e}}async __authRequest(e,t=(()=>{})){const a=localStorage.getItem("token");if(a)try{const r=await this.__request("auth/verify/"+a);if(e&&r.verify)return t(),!0;if(!e||!r.success)return t(),!1}catch(e){console.log(e)}}}},80:function(e,t,a){"use strict";a.r(t);var r=a(15),s=(a(60),a(76),a(77),a(30),a(61),a(21));class i extends s.a{static get properties(){return{name:String,email:String,role:String,password:String,username:String,img:String}}constructor(){super(),this.name="",this.email="",this.role="",this.password="",this.username=""}render(){return r.c`
            <div>
